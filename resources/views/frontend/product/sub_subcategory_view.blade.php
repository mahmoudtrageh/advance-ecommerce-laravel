...
@section('content')
@section('title')
{{trans('site.subsubcategory-page')}}
@endsection
  ...
  <div class="container">
    <div class="breadcrumb-inner">
      <ul class="list-inline list-unstyled">
        ...
        @foreach($breadsubsubcat as $item)
        <li class='active'>@if(session()->get('lang') == 'hi') {{ $item->subcategory->subcategory_name_hin }} @else {{ $item->subcategory->subcategory_name_en }} @endif</li>
        @endforeach

         @foreach($breadsubsubcat as $item)
        <li class='active'>@if(session()->get('lang') == 'hi') {{ $item->subsubcategory_name_hin }} @else  {{ $item->subsubcategory_name_en }} @endif</li>
        @endforeach
...
<div class="body-content outer-top-xs">
    ...
    @endforeach              
            ...
            <div class="sidebar-widget wow fadeInUp">
              <div class="widget-header">
                ...
                <form action="{{ route('subsubcat.shop.filter', ['subsubcat_id' => $subsubcat_id, 'slug' => $slug]) }}" method="post">
                  @csrf
                  @php
 ...
 <span class="badge badge-danger" style="background: #808080">@if(session()->get('lang') == 'hi') 
  {{ $item->category->category_name_hin }} @else  {{ $item->category->category_name_en }} @endif</span>
 ...
 <span class="badge badge-danger" style="background: #808080">@if(session()->get('lang') == 'hi') 
  {{ $item->subcategory->subcategory_name_hin }}  @else {{ $item->subcategory->subcategory_name_en }} @endif</span>
        @endforeach

         @foreach($breadsubsubcat as $item)
        
  <span class="badge badge-danger" style="background: #FF0000">@if(session()->get('lang') == 'hi') 
    {{ $item->subsubcategory_name_hin }} @else {{ $item->subsubcategory_name_en }} @endif</span>
        @endforeach

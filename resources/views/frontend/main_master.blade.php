...
<link rel="stylesheet" href="{{ asset('frontend/assets/css/owl.carousel-en.css') }}">
...
.top-bar .cnt-block, .dropdown.special-menu{
...
<script src="{{ asset('frontend/assets/js/owl-en.carousel.min.js') }}"></script> 

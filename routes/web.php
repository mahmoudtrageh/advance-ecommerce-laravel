...
Route::get('set-lang/{lang}', [LanguageController::class, 'change_lang'])->name('site.change.lang');
...
Route::post('/subcategory/product/{subsubcat_id}/{slug}/filter', [IndexController::class, 'subCatShopFilter'])->name('subcat.shop.filter');
Route::post('/subsubcategory/product/{subsubcat_id}/{slug}/filter', [IndexController::class, 'subsubCatShopFilter'])->name('subsubcat.shop.filter');
...
Route::post('/product/tag/{tag}/filter', [IndexController::class, 'TagShopFilter'])->name('tag.shop.filter');
Route::post('/search/{category}/{item}/filter', [ShopController::class, 'SearchShopFilter'])->name('search.shop.filter');
